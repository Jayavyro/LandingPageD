...
import type { WorkflowSolution } from '../../constants/workflowSolutions'
import './WorkflowSolutionCard.css'
...
function WorkflowSolutionCard({ solution, index }: WorkflowSolutionCardProps) {
...
export default WorkflowSolutionCard
